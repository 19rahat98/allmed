...
class GlobalPrefConstant {
  ...
  /// персональные настроики торговли
  static const prefChartTimeFrame = 'prefChartTimeFrame';
  static const prefOrderType = 'prefOrderType';
  static const prefOrderTimeFrame = 'prefOrderTimeFrame';
  static const prefOrderQuantityType = 'prefOrderQuantityType';
  static const prefStopLossPercent = 'prefStopLossPercent';
  static const prefTakeProfitPercent = 'prefTakeProfitPercent';
  static const prefWatchListStatus = 'prefWatchListStatus';
